...
const RecipeA: NextPage = () => {
  return (
    <div className="w-full relative bg-orange overflow-y-auto flex flex-row items-start justify-center py-0 pr-10 pl-0 box-border gap-[40px] tracking-[normal] mq750:pl-5 mq750:box-border mq675:gap-[40px]">
      <RightPanel />
      <section className="h-[832px] flex-1 overflow-y-auto flex flex-col items-center justify-start py-10 px-0 box-border gap-[28px] max-w-[calc(100%_-_260px)] text-left text-45xl text-white font-poppins mq750:pt-[26px] mq750:pb-[26px] mq750:box-border mq750:max-w-full mq450:pt-5 mq450:pb-5 mq450:box-border">

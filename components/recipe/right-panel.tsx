...
const RightPanel: NextPage = () => {
  return (
    <div className="min-h-screen h-full w-[220px] rounded-tl-none rounded-tr-3xl rounded-br-3xl rounded-bl-none bg-white overflow-hidden shrink-0 flex-col items-start justify-start py-0 px-2.5 box-border gap-[10px] text-center text-xs text-black font-poppins hidden lg:block">
      ...
      <div className="self-stretch h-[470px] flex flex-row items-end justify-start py-5 px-2.5 box-border flex-[0.8529] text-gray-100 cursor-pointer">
        <div className="flex flex-row items-center justify-start py-0 pr-7 pl-0 gap-[5px]">
          <img
            className="h-24 w-[115px] relative"
            loading="eager"
            alt=""
            src="/sign_out.svg"
          />

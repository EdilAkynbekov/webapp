...
const ChoiceFrame: NextPage = () => {
  ...
  return (
    <section className="w-[951px] relative rounded-xl bg-white flex flex-col items-center justify-start py-5 px-0 box-border gap-[20px] md:gap-[54px] text-left text-lg text-black font-poppins">
      ...
      <div className="self-stretch flex flex-col items-center justify-start gap-[34px] text-center text-sm text-darkslategray px-[30px] md:px-[60px] lg:px-[50px]">
        {/* Grid container */}
        <div className="w-[187px] items-start justify-start py-0 px-[50px] box-border text-base text-white">
          <div className="flex-1 rounded-xl bg-black flex flex-row items-center justify-center p-px">
            <b className="h-[31px] w-[77.4px] relative flex items-center justify-center">
              Protein
            </b>
          </div>
        </div>
        <div className="grid grid-cols-4 md:grid-cols-8 lg:grid-cols-8 xl:grid-cols-8 gap-[15px] md:gap-[20px] lg:gap-[30px] w-full ">
          <button className="cursor-pointer py-[20px] md:py-[10px] bg-white flex-1 rounded-8xs shadow-[0px_1px_10px_rgba(0,_0,_0,_0.25)] box-border flex flex-row items-center justify-center min-w-[106px] border-none border-white hover:bg-slate-300 hover-parent">
